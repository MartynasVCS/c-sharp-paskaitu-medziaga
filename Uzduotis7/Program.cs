    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Console.WriteLine("Įvestas skaičius: '{0}'", skaicius);
            Console.WriteLine("Šio skaičiaus kvadratas: '{0}'", skaicius * skaicius);
            Console.WriteLine("Kitaip suskaičiuotas kvadratas: '{0}'", Math.Pow(skaicius, 2));
            Console.WriteLine();
            ...
            Console.WriteLine("Buvo įvesti šie skaičiai: '{0}', '{1}' ir '{2}'", skaicius1, skaicius2, skaicius3);
            
            Console.WriteLine("Veiksmai su įvestais skaičiais:");
            Console.WriteLine("{0} + {1} + {2} = {3}", skaicius1, skaicius2, skaicius3, suma);
            Console.WriteLine("{0} - {1} - {2} = {3}", skaicius1, skaicius2, skaicius3, skirtumas);
            Console.WriteLine("{0} * {1} * {2} = {3}", skaicius1, skaicius2, skaicius3, sandauga);
            Console.WriteLine("{0} / {1} / {2} = {3}", skaicius1, skaicius2, skaicius3, dalyba);
        }
    }
}
