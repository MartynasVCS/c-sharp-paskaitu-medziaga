...
namespace Uzduotis16
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Lyginių skaičių tarp 20 ir 40 suma: '{0}'", suma);
            Console.WriteLine();
            ...
            Console.WriteLine("Nelyginių skaičių tarp 30 ir 60 suma: '{0}'", suma);
            Console.WriteLine();
            ...
            Console.WriteLine("Skaičių (0, 1000) kurie dalijasi iš 3 arba 5 suma: '{0}'", suma);
            Console.WriteLine();
        }
    }
}
